namespace Pure3D.Chunks
{
    ...
    /// </summary>
    [ChunkType(81920)]
    public class Locator(File file, uint type) : VersionNamed(file, type)
    {
        ...
        {
            return $"Locator: {Name} (Position: ({Position}), Version: {Version})";
        }
    ...
    public class Locator2 : Named
    {
        ...
        public override void ReadHeader(Stream stream, long length)
        {
            ...
            Position = Util.ReadVector3(reader);
            NumTriggers = reader.ReadUInt32();
        }

        public override string ToString()
        {
            return $"{Name} Locator Type: {LocatorType} ({NumTriggers} Triggers)";
        }
    ...
    /// </summary>
    public class Locator2Data(byte byte1, byte byte2, byte byte3, byte byte4)
    {
        /// <summary>
    ...
    [ChunkType(50331660)]
    public class LocatorMatrix(File file, uint type) : Chunk(file, type)
    {
